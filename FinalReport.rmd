...
We intend to get a small subset of data out from the GSS data set we uploaded. We will focus onlt on the RACE and CAPPUN variables. This is a categorical by categorical problem so we will be using the categorical by categorical helper file.
...
We can see a difference within the black community where majority opposes capital punnishment meanwhile in the white and other communities majority support capital punishment. 
